...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.project.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.project.app.security.DomainUserDetailsService", "createSpringSecurityUser");
